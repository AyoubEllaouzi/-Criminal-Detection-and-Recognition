...
spark = SparkSession.builder \
    .appName("KafkaConsumerApp2") \
    .config("spark.driver.extraClassPath", "mongodb-driver-3.5.0.jar") \
    .getOrCreate()
...
mongo_properties = {
    ...
    "database": "crime_database",  # Change this to your MongoDB database name
    "collection": "crime_collection"  # Change this to your MongoDB collection name
}
...
query = parsed_df.writeStream \
    ...
    .foreachBatch(lambda df, epoch_id: df.write \
                  .format("mongo") \
                  .option("uri", mongo_properties["uri"]) \
                  .option("database", mongo_properties["database"]) \
                  .option("collection", mongo_properties["collection"]) \
                  .mode("overwrite")  # Use "overwrite" or "append"
                  .save()) \
    .start()
